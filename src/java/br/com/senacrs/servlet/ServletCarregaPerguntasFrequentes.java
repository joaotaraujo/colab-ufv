...
public class ServletCarregaPerguntasFrequentes extends HttpServlet{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            ArrayList<PerguntaFrequenteBean> perguntasFrequentes =  pd.listarPerguntasFrequentes((String) sessao.getAttribute("projetoEscolhido")); 
