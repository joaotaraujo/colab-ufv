...
<body>
    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome">
                    <form method="post" action="/ProjetoColabUFV/ServletCadastraTopico">
                        <table border="1" width="45%" cellpadding="5">
                            <thead>
                                <tr>
                                    <th colspan="2"><h3>Cadastrar um tópico</h3></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td style="width:20%;"><button type="submit" name="Submit" value="Cadastrar topico">Cadastrar</button></td>  
                                    <td style="width:80%;"><button type="reset">Resetar</button></td>
                                </tr>
                            </tbody>
                        </table>
                        <p>${mensagemCadastraTopico}</p>
                    </form>
                    <br>
