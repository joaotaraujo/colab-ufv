    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome">
                    ...
                    <form method="post" action="/ProjetoColabUFV/ServletCadastraPapel">
                        <table border="1" width="45%" cellpadding="5">
                            <thead>
                                <tr>
                                    <th colspan="2"><h3>Cadastrar um papel</h3></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td style="width:20%;">Função</td>
                                    <td style="width:80%;"><input size=75 type="text" name="funcao" value="" /></td>
                                </tr>
                                <tr height=85>
                                ...
                                <tr>
                                <td><button type="submit" name="Submit" value="Cadastrar grupo">Cadastrar</button></td>  
                                <td><button type="reset">Resetar</button></td>
                                </tr>
                            </tbody>
                        </table>
                        <p>${mensagemCadastraPapel}</p>
                    </form>
                    <br>
