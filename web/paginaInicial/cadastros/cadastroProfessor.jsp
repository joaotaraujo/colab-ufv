...
<body>
    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome">
                    <form method="post" action="/ProjetoColabUFV/ServletCadastraProfessor">
            
                        <table border="1" width="30%" cellpadding="2">
                            <thead>
                                <tr>
                                    <th colspan="2"><h3>Cadastrar professor</h3></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:80%;"><input size="75" type="text" name="matricula" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Email</td>
                                    <td style="width:80%;"><input size="75" type="text" name="email" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Login</td>
                                    <td style="width:80%;"><input size="75" type="text" name="login" value="" /></td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">Senha</td>
                                    <td style="width:80%;"><input size="75" type="password" name="senha" value="" /></td>
                                </tr>
                                <td><button type="submit" name="Submit" value="Cadastrar professor">Cadastrar</button></td>  
                                <td><button type="reset">Resetar</button></td>
                            </tbody>
                        </table>
                        <p>${mensagemCadastraProfessor}</p>
                    </form>
                    <br>
