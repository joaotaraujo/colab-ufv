...
<body>
    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome">
                    <form method="post" action="/ProjetoColabUFV/ServletCadastraProjeto">
                        <table border="1" width="45%" cellpadding="5">
                            <thead>
                                <tr>
                                    <th colspan="2"><h3>Cadastrar projeto</h3></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td style="width:20%;">Data Termino</td>
                                ...
                                <td><button type="submit" name="Submit" value="Cadastrar projeto">Cadastrar</button></td>  
                                <td><button type="reset">Resetar</button></td>
                                </tr>
                            </tbody>
                        </table>
                        <p>${mensagemCadastraProjeto}</p>
                    </form>
                    <br>
