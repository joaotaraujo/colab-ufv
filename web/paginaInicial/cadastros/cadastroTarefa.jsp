    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome">
                    ...
                    <form method="post" action="/ProjetoColabUFV/ServletCadastraTarefa">
            
                        <table border="1" width="45%" cellpadding="2">
                            <thead>
                                <tr>
                                    <th colspan="2"><h3>Cadastrar tarefa</h3></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width:80%;"><select name = "atividadeDaTarefa" style="width: 150px">
                                ...
                                <tr>
                                    <td style="width:20%;">Prioridade:</td>
                                    <td style="width:80%;">
                        ...
                        <p>${mensagemCadastraTarefa}</p>
                    </form>
                    <br>
                    <form method="post" action="/ProjetoColabUFV/paginaInicial/cadastros/tipoDeCadastro.jsp">
                    <button type="submit" name="Submit" size=100 value="voltar">Voltar</button></form>
