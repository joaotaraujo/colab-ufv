<%@page import="br.com.senacrs.dao.AlertaDAO"%>
...
<body>
    ...
    <!--exibe alerta apenas uma vez -->
    <%if (session.getAttribute("mostrarAlerta") == "0"){%>
    ${alertasPendentes}
    ...
    <div id="right">
        <div id="welcome">
                ...
                <table  style="width: 725px;" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr >
                            <th style="background:#BCC5FF;color:#000000;font-size:17px;"><center>Cronograma do Projeto</center></th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
            ...
            ${tabelaAtvConcluida}
            <!--
        <div id="block_right" style="padding-top:50px;">
            <div class="buttonChat" bgcolor=\"FF0000\"><center><a href="/ProjetoColabUFV/start.jsp">Chat Online!</a></center></div>
            <div class="clear"></div>
        </div>-->
    </div>
