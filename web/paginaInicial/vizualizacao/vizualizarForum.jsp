...
<body>
    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome">
                <br>
                <center><h5 style="font-size:30px;">ColabUFV - Fórum</h5></center>
                <br>
                <table style="width: 725px;" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th style="width:50%;">Tópicos</th>
                ...
                <form method="post" action="/ProjetoColabUFV/paginaInicial/cadastros/cadastroTopico.jsp">
                    <button style="width: 180px" type="submit" name="Submit" value="Adicionar topico">Novo Tópico</button>    
                </form>
            </div>
        </div>
    <div class="clear"></div>
