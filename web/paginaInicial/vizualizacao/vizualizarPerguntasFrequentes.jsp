        ...
        <div id="right">
            <div id="welcome">
                    ...
                    <table  height="20" style="width: 710px;" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th><center>Perguntas Frequentes</center></th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
                    ${perguntasFrequentes}
                    <br>
                    <form method="post" action="/ProjetoColabUFV/paginaInicial/cadastros/cadastroPerguntaFrequente.jsp">
                        <button style="width: 180px" type="submit" name="Submit" value="Adicionar pergunta frequente">Nova Pergunta</button>    
                    </form>
                <div class="clear"></div>
            </div>
