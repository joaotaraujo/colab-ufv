        ...
        <div id="right">
            <div id="welcome">
                ...
                <br>  
                    ...
                    ${mensagemCadastrarEnvolvidoPapel}
                    
                <br><br>
                <table  height="20" style="width: 720px;" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                ...
                <br>
                <form method="post" action="/ProjetoColabUFV/ServletCadastraEnvolvidoPapel?redirect=${redirect}">
                    <select name="envolvidoParaCadastrarPapel" style="width:150px;">
                        ${envolvidosParaCadastrar}
                    </select>
                    <button type="submit" name="Submit" value="Cadastrar envolvido papel">Cadastrar envolvido</button> 
                </form>
                ${envolvidos}
                <br>
                <form method="post" action="/ProjetoColabUFV/ServletCarregaInformacoesProjeto">
