...
$(document).ready(function() {
	$('#alertasEnviadosTabela').DataTable( {
		"scrollY":        "120px",
		"scrollCollapse": true,
		"paging":         false
	} );
        $('#alertasRecebidosTabela').DataTable( {
		"scrollY":        "120px",
		"scrollCollapse": true,
		"paging":         false
	} );
    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome">
                    ...
                    <table style="width: 705px;" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th><h3><center>Alertas Recebidos</center></h3>
                                </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    ...
                    <table style="width: 705px;" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th><h3><center>Alertas Enviados</center></h3>
                                </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    ...
                    <br><br>
                    <form method="post" action="/ProjetoColabUFV/ServletCarregaEnviaAlerta">
                        <button style="width: 150px" type="submit" name="Submit" value="Envia alerta">Enviar Alerta</button>    
                    </form>
