        ...
        <div id="right">
            <div id="welcome">
                <table  height="20" style="width: 715px;" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th><center>Selecione um aluno para gerar relatório</center></th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
                <br>
                    ${alunos}
                <br>
                <form method="post" action="/ProjetoColabUFV/ServletCarregaRelatorioGeral?ranking=Atividades feitas">  
                    <button type="submit" name="Submit" value="relatorioGeral">Relatório Geral</button>
                </form>
