    ...
    <div id="content">
        ...
        <div id="right">
            <div id="welcome">
                    ...
                    <form method="post" action="/ProjetoColabUFV/ServletRecuperaArquivo">
                        <button style="width: 180px" type="submit" name="Submit" value="Adicionar topico">Recuperar Arquivo</button>    
                    </form>
                <div class="clear"></div>
            </div>
        </div>
