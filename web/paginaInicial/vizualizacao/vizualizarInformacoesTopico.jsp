...
$(document).ready(function() {
    ...
    <div id="content">
        ...
        function valida_form (){
            if(document.getElementById("comentarioTopico").value.length === 0){
            alert('Seu comentário está vazio!');
            document.getElementById("comentarioTopico").focus();
            return false
            }
            }
        </script>            
        <div id="right">
            <div id="welcome">
                ...
                <form method="post" action="/ProjetoColabUFV/ServletEnviaComentario" onsubmit="return valida_form(this)">
                    <table>
                        <thead>
                            <tr>
                                <th COLSPAN="3">
                                    <h3 style="font-size:16px;">Enviar Comentario</h3>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td style="font-size:16px;width:30%;">${nomeUsuario}<p>${tipoUsuario}<p>${papelUsuario}</td>
                                <td BGCOLOR="WHITE" style="padding-top:0px;padding-left:0px;padding-right:0px;padding-bottom:0px;width:50%;"><textarea name="comentarioTopico" id="comentarioTopico" cols="58" rows="6"></textarea></td>
                                <td style="width:20%;"><button style="height:50px;" type="submit" name="Submit" value="Enviar Comentario">Enviar</button></td>
                            </tr>
                        </tbody>
                    </table>
                </form>
                         
                <form method="post" action="/ProjetoColabUFV/ServletCarregaForum">
