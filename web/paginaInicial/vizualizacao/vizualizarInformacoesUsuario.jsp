    ...
    <div id="content">
        <div id="left">
            <div>
                ...
                <a href="#"><h1>Enviar um email</h1></a>
            ...
            <div id="welcome">
                ...
                <!--<table><head></head>
                    <body>
                        <tr>
                            <td width="50%">
                                <form method="post" action="/ProjetoColabUFV/ServletCarregaEditaUsuario">
                                    <center><button type="submit" name="Submit" value="Editar usuario">Editar Usuário</button></center>    
                                </form>
                            </td>
                            <td width="50%">
                                <form method="post" action="/ProjetoColabUFV/ServletDeletaUsuario">
                                    <center><button type="submit" name="Submit" value="Deletar grupo">Deletar Usuário</button></center>    
                                </form>
                            </td>
                    </body>
                </table>-->
